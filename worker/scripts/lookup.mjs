...
const agent =
  process.argv[2] || '0x9eeed099a0ff576571ffdb5c494db31a3ab2f6c2c76511a778ce5d3952c2ee43';
...
tx.moveCall({
  target: `${MG.published_at}::passport::get_passport_id`,
  arguments: [tx.object(MG.agent_registry), tx.pure.address(agent)],
});
...
tx2.moveCall({
  target: `${DB.package_id}::balance_manager::balance`,
  typeArguments: [DB.dbusdc_coin_type],
  arguments: [tx2.object(bm)],
});
