// Deployment constants as a plain ESM module (mirrors repo-root
// deployment.testnet.json, the canonical record). Used instead of a JSON import
// so the same module loads under both Node (verify scripts) and esbuild
// (wrangler), which disagree on JSON import-attribute syntax.
export default {
  chain: 'sui:testnet',
