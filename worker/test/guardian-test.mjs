...
import { runGuardian, GUARDIAN_REASON as R } from '../src/guardian.js'
...
const base = {
  ...
  wrapper: { mandate_id: MID, pool_id: POOL, budget_ceiling: '1000000', spent_amount: '0', max_slippage_bps: 100 },
