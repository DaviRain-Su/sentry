...
export function Icon({ name, size = 18, stroke = 1.7, style }) {
  ...
  const paths = {
    ...
    copy: <><rect x="9" y="9" width="11" height="11" rx="2.2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></>,
    key: <><circle cx="8" cy="14" r="4.5"/><path d="M11.2 10.8 20 2M16 6l3 3M14 8l2.5 2.5"/></>,
